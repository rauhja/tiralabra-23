...
class AnalysisFrame(customtkinter.CTkFrame):
    def __init__(self, *args, **kwargs):
        ...
        self.header = customtkinter.CTkLabel(self, text="Analysis", font=customtkinter.CTkFont(size=15, weight="bold"))
        self.header.grid(row=0, column=0, padx=(10, 10), pady=(10, 10))
        
        self.input_label = customtkinter.CTkLabel(self, text="Select file to analyse:")
        self.input_label.grid(row=1, column=0, columnspan=2, sticky="w", padx=(10, 0), pady=(0, 0))

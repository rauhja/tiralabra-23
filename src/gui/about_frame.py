...
class AboutFrame(customtkinter.CTkFrame):
    def __init__(self, *args, **kwargs):
        ...
        self.header = customtkinter.CTkLabel(self, text="About", font=customtkinter.CTkFont(size=15, weight="bold"))
        self.header.grid(row=0, column=0, columnspan=2, padx=(10, 10), pady=(10, 10))
        ...
        self.text_label.grid(row=1, column=0, columnspan=2, padx=(10, 10), pady=(10, 10))
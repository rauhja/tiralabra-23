...
class AnalysisService:
    ...
    def run_analysis(self, filename):
        ...
        self.log["huff_comp_ratio"] = self.get_compression_ratio(
            self.log["original_size"], self.log["huff_comp_size"]
        )
        self.log["huff_comp_space_saving"] = self.get_space_saving(
            self.log["original_size"], self.log["huff_comp_size"]
        )
        ...
        self.log["lzw_comp_ratio"] = self.get_compression_ratio(
            self.log["original_size"], self.log["lzw_comp_size"]
        )
        self.log["lzw_comp_space_saving"] = self.get_space_saving(
            self.log["original_size"], self.log["lzw_comp_size"]
        )
